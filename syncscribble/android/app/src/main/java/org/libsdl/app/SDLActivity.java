...
*/
    ...
    /* Write: don't intercept volume/camera/zoom keys -- the app uses volume keys itself
    @Override
...
//        }
    ...
    /* Write: give the app access to the SDL surface view for its own input listeners */
    public static SDLSurface getSDLSurfaceView() { return SDLActivity.mSurface; }
